...
const handlerWrapperArgs = { functionName: 'covidsource-dev-ingest_us_data', timeout: 30 };

try {
  const userHandler = require('./handler_data.js');
  module.exports.handler = serverlessSDK.handler(userHandler.ingest_us_data, handlerWrapperArgs);
} catch (error) {
